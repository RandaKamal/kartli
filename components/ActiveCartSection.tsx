    ...
    <div className="space-y-6">
      ...
      {totalHouseholdCartCount === 0 ? (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          {/* Left Column: Merged Header + Your Staged Items */}
          <Card className="border border-border bg-card rounded-3xl p-4 sm:p-6 shadow-sm space-y-4">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-2.5">
              <Button
                ...
                onClick={handleClearCart}
                disabled={isPending || myCartItems.length === 0}
                className="w-full sm:w-auto rounded-xl text-xs font-semibold h-9 px-3.5 gap-1.5 border-border hover:bg-secondary justify-center"
              ...
              <Button
                ...
                onClick={handleProceedToCheckout}
                disabled={myCartItems.length === 0}
                className="w-full sm:w-auto rounded-xl text-xs font-semibold h-9 px-4 gap-2 shadow-sm justify-center"
                title="Proceed to checkout"
              >
                <Receipt className="w-4 h-4" />
                <span>Checkout</span>
