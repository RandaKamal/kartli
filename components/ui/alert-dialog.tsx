...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Cancel
    ...
    className={cn(
      ...
      "mt-2 sm:mt-0 text-zinc-300 hover:text-white",
      className
    )}
    {...props}
  />
